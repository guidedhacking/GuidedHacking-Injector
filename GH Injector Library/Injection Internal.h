...
ALIGN struct INJECTION_DATA_INTERNAL
{
	...
	ALIGN LDRP_UNICODE_STRING_BUNDLE ModuleFileNameBundle;

	ALIGN LDRP_PATH_SEARCH_CONTEXT SearchPathContext;
...
ALIGN_86 struct INJECTION_DATA_INTERNAL_WOW64
{
	...
	ALIGN_86 LDRP_UNICODE_STRING_BUNDLE32 ModuleFileNameBundle;

	ALIGN_86 LDRP_PATH_SEARCH_CONTEXT32 SearchPathContext;
